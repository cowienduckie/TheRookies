...
public class BookService : IBookService
{
    ...
    public async Task<CreateBookResponse?> CreateAsync(CreateBookRequest requestModel)
    {
        ...
        if (categories.Count != categoryIds.Count()) return null;

        var newBook = new Book
        {
            Name = requestModel.Name,
            Description = requestModel.Description,
            Cover = string.IsNullOrEmpty(requestModel.Cover)
                ? Settings.BaseBookCoverUrl
                : requestModel.Cover,
    ...
    public async Task<PagedList<GetBookResponse>> GetPagedListAsync(
    ...
    public async Task<UpdateBookResponse?> UpdateAsync(UpdateBookRequest requestModel)
    {
        ...
        book.Cover = string.IsNullOrEmpty(requestModel.Cover)
            ? book.Cover
            : requestModel.Cover;
